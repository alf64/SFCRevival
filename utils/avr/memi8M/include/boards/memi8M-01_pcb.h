...
#define BOARD_SPACE_CAPACITY (MEM_SPACE_CAPACITY)

#define BOARD_MIN_ADDRESS (MEM_MIN_ADDRESS)
#define BOARD_MAX_ADDRESS (MEM_MAX_ADDRESS)

#define BOARD_SECTOR_COUNT (MEM_SECTOR_COUNT)
#define BOARD_BLOCK_COUNT (MEM_BLOCK_COUNT)

#define BOARD_MIN_SECTOR_ADDRESS (MEM_MIN_SECTOR_ADDRESS)
#define BOARD_MAX_SECTOR_ADDRESS (MEM_MAX_SECTOR_ADDRESS)

#define BOARD_MIN_BLOCK_ADDRESS (MEM_MIN_BLOCK_ADDRESS)
#define BOARD_MAX_BLOCK_ADDRESS (MEM_MAX_BLOCK_ADDRESS)
